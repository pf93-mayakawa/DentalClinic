...
<ul>
  <li class="current">
    <a href="<?php echo esc_url(home_url('/')); ?>" rel="home">ホーム<span>Home</span></a>
  </li>
  
  <li><a href="<?php echo esc_url(home_url('/clinic/')); ?>">クリニック紹介<span>Information</span></a>
    <ul class="ddmenu">
      <li><a href="<?php echo esc_url(home_url('/clinic/')); ?>">クリニック紹介</a></li>
      <li><a href="<?php echo esc_url(home_url('/clinic/greeting/')); ?>">院長挨拶</a></li>
      <li><a href="<?php echo esc_url(home_url('/clinic/staff/')); ?>">スタッフ紹介</a></li>
    </ul>
  </li>

  <li><a href="<?php echo esc_url(home_url('/medical/')); ?>">診療内容<span>Medical</span></a>
    <ul class="ddmenu">
      <li><a href="<?php echo esc_url(home_url('/medical/general/')); ?>">一般歯科</a></li>
      <li><a href="<?php echo esc_url(home_url('/medical/child/')); ?>">小児歯科</a></li>
      <li><a href="<?php echo esc_url(home_url('/medical/surgery/')); ?>">口腔外科</a></li>
      <li><a href="<?php echo esc_url(home_url('/medical/preventive/')); ?>">予防歯科</a></li>
    </ul>
  </li>

  <li><a href="<?php echo esc_url(home_url('/blog/')); ?>">ブログ<span>Blog</span></a></li>

  <li><a href="<?php echo esc_url(home_url('/contact/')); ?>">ご予約・お問い合わせ<span>Contact</span></a>
    <ul class="ddmenu">
      <li><a href="<?php echo esc_url(home_url('/contact/reserve/')); ?>">ご予約</a></li>
      <li><a href="<?php echo esc_url(home_url('/contact/form/')); ?>">お問い合わせ</a></li>
    </ul>
  </li>
...
<li><a href="<?php echo esc_url(home_url('/clinic/')); ?>">クリニック紹介<span>Information</span></a></li>
